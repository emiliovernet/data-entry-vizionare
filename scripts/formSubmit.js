...
// // Función para mostrar un mensaje de error con el color especificado
// function updateMessage(content, backgroundColor, textColor) {
//   const messageElement = document.getElementById("message");
...
//     if (areFormDataEqual(currentFormData, previousFormData)) {
//       // Mostrar mensaje de datos duplicados en rojo
//       updateMessage("Datos duplicados", "red", "white");
//       return;
//     }

//     updateMessage("Enviando..", "beige", "green");
...
//       })
//       .then(function (data) {
//         updateMessage("Envío de datos exitoso", "green", "beige");
//       })
//       .catch(function (error) {
//         console.error(error);
//         updateMessage("An error occurred while submitting the form.", "red", "white");
//       });
